...
%			Maturation of B cells integrates numerous internal and environmental signals, so controlling for developmental stage has significant challenges. 
		...
		The following table is a compilation of information on samples kindly donated by the Pediatric Department of the Wolfson Medical centre in Israel. Data includes samples collected from four other research groups as well as their own data. 
					...
					\begin{landscape} % Sample table
						...
						\begin{longtable}[c]{|l | l |p{4cm}|l|l|l|l|l|}
							\caption{Clinical details of patients with THI. Abbreviations: m, months; y, years; CVID, common variable immunodeficiency; -, unknown; def, deficiency.} \\ \hline 	
							...
							5  & Whole Blood & 9m, 11m, 1y 3m, 1y 5m, 1y 8m                             & Male   & Asian     & Breastfed  & Vaginal           & Brother with CVID     \\ \hline
							...
							& Tonsils        & 3y 2m                                                    &        &           &            &                   &  \\ \hline
							15 & Whole Blood & 7m, 11m, 1y 1m                                           & Male   & Caucasian & Breastfed  & Vaginal           & Sister with IgA def. \\ \hline
	...
	%	\includepdf[pages=-]{../Reading/DNA_methylation_dynamics_during_B_cell_maturation_underlie_a_continuum_of_disease_phenotypes_in_chronic_lymphocytic_leukemia}
%		\includepdf[pages=-]{../Reading/Tallmadge15.pdf}
