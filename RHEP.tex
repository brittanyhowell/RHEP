...
%		{\Huge May be important, may be able to delete}
		...
		\subsection{Review of etiology and theories: \citeauthor{Ovadia14} \citeyear{Ovadia14}}
			...
			{\Huge The most peculiar thing about THI is that it is self limited; the recurrent infections stop and serum IgG levels increase spontaneously} \citep{Tiller78,McGeady87} {\Huge More to cite here}
			most studies have found that lymphocyte subpopulations and cellular immunity are intact, including the level of memory and class-switched B cells. {\Huge Find citations in Ovadia}
			...
			{\Huge The mechanism is unknown, this is what we're working from:}
			Investigators have found reduced frequencies of both circulating IgM+ and ``switched" memory B cells as well as an inability to produce IgG in vitro \citep{Ovadia14}.
			\citet{McGeady87} said that the concept of delayed activation is consistent with most immunologists' current perception of THI
